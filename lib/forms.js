      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            label:
              'Ich bin damit einverstanden, dass meine eingegebenen Daten für 24 Stunden zwischengespeichert werden und mir eine E-Mail zur Bestätigung der Anmeldung zugeschickt wird.',
            type: 'boolean',
            rules: [v => (v ? true : 'Diese Zustimmung ist erforderlich')],
            component: 'ec-checkbox'
          },
